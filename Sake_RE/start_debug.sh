...
# wait for user
read -p 'PRESS ENTER TO ATTACH GDB WHEN READY   PRESS ENTER TO ATTACH GDB WHEN READY   PRESS ENTER TO ATTACH GDB WHEN READY   PRESS ENTER TO ATTACH GDB WHEN READY   PRESS ENTER TO ATTACH GDB WHEN READY   PRESS ENTER TO ATTACH GDB WHEN READY   PRESS ENTER TO ATTACH GDB WHEN READY   PRESS ENTER TO ATTACH GDB WHEN READY   PRESS ENTER TO ATTACH GDB WHEN READY   PRESS ENTER TO ATTACH GDB WHEN READY   PRESS ENTER TO ATTACH GDB WHEN READY   PRESS ENTER TO ATTACH GDB WHEN READY   PRESS ENTER TO ATTACH GDB WHEN READY   PRESS ENTER TO ATTACH GDB WHEN READY   PRESS ENTER TO ATTACH GDB WHEN READY' none
