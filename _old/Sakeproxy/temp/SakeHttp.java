...
import com.medtronic.SakeClient.SakeAuthenticationStatus;
...
public class SakeHttp extends NanoHTTPD {
    ...
    private NanoHTTPD.Response handleStatus() {
        ...
        SakeAuthenticationStatus status = this.sakeClient.getClientStatus();
    ...
    private NanoHTTPD.Response handleError(Exception e) {
        String err = Utils.exceptionToString(e);
        Utils.logPrint(err);
